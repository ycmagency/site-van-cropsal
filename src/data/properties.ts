...
export const properties: Property[] = [
  {
    ...
    beds: 7,
    baths: 3,
    type: 'Maison à 2 étages',
    price: '1 500 000 $',
    description:
      "Vaste maison à deux étages nichée dans un secteur recherché de Beaconsfield. Avec ses 7 chambres et 3 salles de bain, elle offre des espaces de vie généreux et lumineux, idéale pour une grande famille. Terrain paysager et environnement paisible.",
    features: ['7 chambres', '3 salles de bain', 'Maison à 2 étages', 'Beaconsfield'],
    featured: true,
  },
  {
    id: 'rotonde',
    ...
    city: 'Montréal (Verdun/Île-des-Sœurs)',
    beds: 2,
    baths: 2,
    type: 'Appartement / condo',
    price: '1 190 500 $',
    description:
      "Magnifique appartement à l'Île-des-Sœurs offrant 2 chambres et 2 salles de bain. Finitions haut de gamme, grandes fenêtres et emplacement de choix à proximité des services, du fleuve et du centre-ville de Montréal.",
    features: ['2 chambres', '2 salles de bain', 'Appartement', 'Île-des-Sœurs'],
    featured: true,
  },
  {
    id: 'claude-masson-z',
    ...
    city: 'Montréal (Mercier/Hochelaga-Maisonneuve)',
    beds: 3,
    baths: 1,
    type: 'Maison à paliers multiples',
    price: '699 000 $',
    description:
      "Maison à paliers multiples dans le quartier Mercier/Hochelaga-Maisonneuve. 3 chambres et une salle de bain, espaces modulables et lumineux. Secteur familial bien desservi par les transports et les commerces.",
  ...
  },
  {
    ...
    price: '149 000 $',
    description:
      "Charmante maison de plain-pied à Saint-Liguori, dans Lanaudière. 2 chambres et une salle de bain sur un grand terrain verdoyant. Une occasion abordable, parfaite comme premier achat ou comme chalet à la campagne.",
  ...
  },
  {
    ...
    price: '690 000 $',
    description:
      "Belle maison de plain-pied à Saint-Rémi offrant 4 chambres et une salle de bain. Idéale pour une famille en quête de tranquillité, avec grand terrain et environnement champêtre tout en restant à proximité des services.",
    features: ['4 chambres', '1 salle de bain', 'Plain-pied', 'Saint-Rémi'],
  },
  {
    id: 'anderson',
    ...
    city: 'Montréal (Pierrefonds-Roxboro)',
    beds: 4,
    baths: 1,
    type: 'Maison à 2 étages',
    price: '680 000 $',
    description:
      "Maison à deux étages à Pierrefonds-Roxboro, 4 chambres et une salle de bain. Quartier résidentiel paisible et verdoyant, près des parcs, écoles et de l'eau. Beaucoup d'espace pour la famille.",
    features: ['4 chambres', '1 salle de bain', 'Maison à 2 étages', 'Pierrefonds-Roxboro'],
  },
  {
    id: 'st-augustin',
    ...
    price: '649 000 $',
    description:
      "Grand terrain à bâtir à Mandeville, dans Lanaudière. Une occasion idéale pour réaliser votre projet de construction ou de villégiature dans un cadre naturel exceptionnel, entouré de nature et de plans d'eau.",
    features: ['Terrain à bâtir', 'Grande superficie', 'Mandeville', 'Lanaudière'],
  },
  {
    id: 'st-andre-vente',
    ...
    price: '635 000 $',
    description:
      "Maison de plain-pied à Pont-Viau, Laval. 3 chambres et 2 salles de bain, parfaite pour une famille. Emplacement central à quelques minutes des ponts, des écoles et des services.",
  ...
  },
  {
    ...
    price: '599 900 $',
    description:
      "Maison de plain-pied à Repentigny offrant 3 chambres et 2 salles de bain. Secteur familial recherché, proche des écoles, parcs et commerces. Aménagement fonctionnel et accueillant.",
  ...
  },
  {
    ...
    price: '526 625 $',
    description:
      "Duplex à Sainte-Rose, Laval. Une belle occasion d'investissement ou de propriété occupée par le propriétaire. Bien situé, à proximité des commerces et du transport.",
  ...
  },
  {
    ...
    beds: 3,
    baths: 2,
    type: 'Plain-pied à louer',
    price: '3 000 $ / mois',
    description:
      "Maison de plain-pied à louer à Pont-Viau, Laval. 3 chambres et 2 salles de bain, prête à accueillir votre famille. Disponible pour location dans un secteur central et bien desservi.",
  ...
  },
  {
    ...
    beds: 2,
    baths: 1,
    type: 'Appartement à louer',
    price: '2 150 $ / mois',
    description:
      "Appartement à louer à Laval-des-Rapides. 2 chambres et une salle de bain, espaces lumineux et modernes. Emplacement pratique près des services, des transports et des grands axes.",
...
// Traductions anglaises (badge, type, description, caractéristiques) par id.
...
const propertiesEn: Record<string, PropEn> = {
  ...
  'rotonde': {
    ...
    description: 'Beautiful apartment on Île-des-Sœurs offering 2 bedrooms and 2 bathrooms. High-end finishes, large windows and a prime location near services, the river and downtown Montreal.',
    features: ['2 bedrooms', '2 bathrooms', 'Apartment', 'Île-des-Sœurs'],
  },
  'claude-masson-z': {
  ...
  'domaine-grenier': {
    ...
    description: 'Charming bungalow in Saint-Liguori, in the Lanaudière region. 2 bedrooms and one bathroom on a large green lot. An affordable opportunity, perfect as a first home or a country cottage.',
    features: ['2 bedrooms', '1 bathroom', 'Bungalow', 'Saint-Liguori'],
  },
  'eglise': {
    badge: 'For sale', type: 'Bungalow',
    description: 'Lovely bungalow in Saint-Rémi offering 4 bedrooms and one bathroom. Ideal for a family seeking tranquility, with a large lot and a country setting while remaining close to services.',
    features: ['4 bedrooms', '1 bathroom', 'Bungalow', 'Saint-Rémi'],
  },
  'anderson': {
    badge: 'For sale', type: 'Two-storey house',
  ...
  'st-augustin': {
    ...
    description: 'Large building lot in Mandeville, in the Lanaudière region. An ideal opportunity to build your dream home or cottage in an exceptional natural setting, surrounded by nature and waterways.',
    features: ['Building lot', 'Large area', 'Mandeville', 'Lanaudière'],
  },
  'st-andre-vente': {
    badge: 'For sale', type: 'Bungalow',
